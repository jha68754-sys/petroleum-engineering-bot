...
HELP_MESSAGE = (
    ...
    "  /calc nodal -- Deterministic IPR×VLP operating point:\n"
    "  [model=auto|linear|vogel|composite] pr= [pb=] [j=] [qmax=] [q_test= pwf_test=]\n"
    "  thp= tvd= id= gor= rs= api= gamma_g= mu_l= bo= t_wh= geothermal= [plot=1]\n"
    "  Example: /calc nodal pr=3000 j=1.5 thp=100 tvd=8000 id=1.995 gor=1000\n"
    "  rs=600 api=35 gamma_g=0.65 mu_l=1 bo=1.4 t_wh=120 geothermal=1.5 plot=1\n"
