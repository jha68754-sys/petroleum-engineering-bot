...
START_MESSAGE = (
    ...
    "v4.2 | Senior Petroleum Engineer Assistant\n\n"
    "Covers: PVT | Reservoir | Simulation | Drilling | Production\n\n"
    "Ask your question or use /help for the full command list."
)

HELP_MESSAGE = (
    "Petroleum Engineering AI Bot -- Command Reference\n\n"
