...
_ARABIC_LABELS = {
    "pr": "ضغط المكمن (Pr)",
    "reservoir_pressure_psia": "ضغط المكمن (Pr)",
    ...
    "gas_specific_gravity": "الكثافة النوعية للغاز (Gas specific gravity)",
    "gamma_w": "الكثافة النوعية للماء (Water specific gravity)",
    "water_specific_gravity": "الكثافة النوعية للماء (Water specific gravity)",
...
_ARABIC_TITLES = {
    "system_v1": "نقطة التشغيل المتكاملة للبئر وChoke",
    "integrated_system_v1": "نقطة التشغيل المتكاملة للبئر وChoke",
    "choke_v1": "أداء Choke",
    "nodal_v1": "Nodal Analysis",
    "vlp_v1": "أداء VLP",
    "gas_lift_v1": "أداء Gas-Lift المستمر",
    "sensitivity_v1": "تحليل Sensitivity",
    "optimize_v1": "تحسين Production Optimization",
}
